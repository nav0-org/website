...
<p style="color: var(--vp-c-text-2); font-size: 0.9rem;">By Ketan Patil &middot; February 21, 2026 &middot; 7 min read</p>
...
_Nav0 is a minimal, privacy-focused browser that believes your browser should browse, nothing more. No accounts, no sync, no data collection. [Learn more](/guide/philosophy)._
