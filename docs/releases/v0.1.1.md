...
- **DRM Playback** — auto-grant mediaKeySystem permission for DRM content playback
...
- **Release Notes Navigation** — moved Releases to a separate 'Release Notes' nav link after Blog
- **Hero Image** — use SVG logo for hero image on the documentation site
- **Sidebar Fix** — fixed blog/release sidebar titles truncated at apostrophes
