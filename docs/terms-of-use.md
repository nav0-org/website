...
eyebrow: Legal
tagline: 'A legally binding agreement between you and the Nav0 Contributors governing your use of the Nav0 Browser and the Nav0 website. By installing or using Nav0, you agree to these terms.'
...
Nav0 is provided "AS IS" and "AS AVAILABLE," without warranty of any kind, express or implied.

</div>

To the maximum extent permitted by applicable law, the Nav0 Contributors disclaim all warranties, including but not limited to:
...
**TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL THE NAV0 CONTRIBUTORS, MAINTAINERS, OR AFFILIATES BE LIABLE FOR ANY:**
...
Sections 6 (Intellectual Property), 7 (Disclaimer of Warranties), 8 (Limitation of Liability), 9 (Indemnification), and 13 (Governing Law) shall survive any termination of these Terms.
...
These Terms shall be governed by and construed in accordance with applicable open-source software norms and, to the extent required, the laws of the jurisdiction in which the primary project maintainer resides, without regard to conflict of law principles.

### Dispute Resolution

Any dispute arising out of or related to these Terms shall first be attempted to be resolved through good-faith negotiation. If negotiation fails, disputes may be resolved through binding arbitration or in a court of competent jurisdiction, as determined by applicable law.
...
<div class="doc-bottomline">
  <strong>By using Nav0, you acknowledge that you have read and understood these Terms and agree to be bound by them.</strong>
  <span><em>Nav0 — Browse. Nothing More.</em></span>
</div>
